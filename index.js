...
if (score > highscore.score) {
    console.log(chalk.bold.cyan("Wow! You scored Highest score now. \n")+chalk.bold.blue(userName)+ chalk.bold.cyan(" Send me your screenshot of score,I will update the highscore."));
}
else {
